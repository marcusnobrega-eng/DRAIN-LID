...
sim_name = 'PP_NWC_Clogging_no_maintenance';
...
if isfield(params,'enable_clogging') && islogical(params.enable_clogging) && params.enable_clogging
    clog_opt = struct( ...
        ...
        'maintenance_period_days', 365*50, ...    % or [] and set 'maintenance_dates_sec'
        'top_N_cells',  3 ...                  % clog top-N cells (override with your choice)
        );
...
% === SAVE FILE ===========================================================
save('Examples/PP_NWC_no_maintenance.mat')
